...
| Last release audit | [`2026-06-29-3.9.6-concurrent-tls-handshake-banking-audit.md`](../audit/2026-06-29-3.9.6-concurrent-tls-handshake-banking-audit.md) (concurrent-TLS-handshake crash — auto-assigned crypto banks + banked HKDF/HMAC/`ed25519_sign`/AEAD scratch; 10 findings, race-validated by `concurrent_tls_handshake.tcyr`). Prior: `2026-06-16-3.8.0-chacha-x25519-banking-audit.md`. |
