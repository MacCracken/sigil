...
| Field | Value |
|---|---|
| Current version | **3.5.1** (`VERSION`) |
| Cyrius toolchain pin | **6.0.3** (`cyrius.cyml [package].cyrius`) |
| Last release date | 2026-05-27 |
| Last release audit | [`2026-05-27-3.5.1-audit.md`](../audit/2026-05-27-3.5.1-audit.md) |
| Phase | Released; **3.5 cycle open** — Poly1305 (3.5.0) + ChaCha20 (3.5.1) shipped; ChaCha20-Poly1305 AEAD + X25519 implemented in `[Unreleased]`, awaiting tags (intended 3.5.2, 3.5.3) |
...
- 3.5.x (`[Unreleased]`): +11 (`chacha20poly1305.tcyr` 5, `x25519.tcyr` 6 — RFC 8439 §2.8.2 + RFC 7748 §5.2/§6.1)
...
| 3.5.x — ChaCha20-Poly1305 AEAD | **Implemented** (in `[Unreleased]`) | `src/chacha20poly1305.cyr` (+5 tests). RFC 8439 §2.8, constant-time tag verify. Awaiting release tag. |
