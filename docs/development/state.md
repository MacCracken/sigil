...
| 3.6.4 — RSA sign hardening + security audit | **Shipped** 2026-06-03 | **CRT** (~4×) + **base blinding** (`bn_modinv` + `/dev/urandom`) on the CT ladder; consolidated security audit pass. RSA PKCS#1 v1.5 surface (verify+keys+sign) complete. |
